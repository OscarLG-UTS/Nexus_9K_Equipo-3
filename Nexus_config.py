...
nr = InitNornir(
    config_file = "C:/Users/MECOSDE/Desktop/Practica_Cisco/config.yaml", dry_run=True
)
Nex1=nr.run(netmiko_send_config, config_file="Nexus.txt")
Nex2=nr.run(netmiko_send_config, config_file="vlan.txt")
Nex3=nr.run(netmiko_send_config, config_commands=["interface lo 6", "description config con Nornir","ip add 6.6.6.6/32"])
